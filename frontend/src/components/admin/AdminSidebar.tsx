...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path d="M2 14 L6 9 L10 11 L16 4" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <circle cx="12" cy="6" r="2.5" stroke="currentColor" strokeWidth="1.3" />
        <path d="M1 15c0-2.761 2.239-5 5-5M12 10c2.761 0 5 2.239 5 5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
      </svg>
    ),
  },
  {
